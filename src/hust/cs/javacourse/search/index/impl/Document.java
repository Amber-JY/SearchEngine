...
public class Document extends AbstractDocument {
     ...
     */
    public Document(){}
    public Document(int docId, String docPath){super(docId, docPath);}
    public Document(int docId, String docPath, List<AbstractTermTuple> tuples){super(docId, docPath, tuples);}
    ...
    public void addTuple(AbstractTermTuple tuple) {
        if(tuple == null || this.tuples.contains(tuple)){
            return;
        }
